...
namespace AliasGenerator
{
    class MUtils
    {
        ...
        /// </summary>
        /// <param elementName="props">PropertyValues collection to search in</param>
        /// <param elementName="propDef">The property definition to look for</param>
        ...
        /// </summary>
        /// <param elementName="propertyID">property to look for</param>
        /// <param elementName="propertyValue">value of property</param>
        ...
        /// </summary>
        /// <param elementName="deleted">true: looking for deleted objects, false: looking for existing objects</param>
        /// <returns>search condition</returns>
        ...
        /// search conditions are used by vault.ObjectSearchOperations etc
        /// </summary>
        /// <param elementName="objectType">object type to check for, generally an int found on the server</param>
        ...
        /// </summary>
        /// <param elementName="checkedOut">true: looking for checked out items, false: looking for checked in items</param>
        /// <returns></returns>
